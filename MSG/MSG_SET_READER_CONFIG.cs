...
// Type: Org.LLRP.LTK.LLRPV1.MSG_SET_READER_CONFIG
...
namespace Org.LLRP.LTK.LLRPV1
{
  public class MSG_SET_READER_CONFIG : Message
  {
    ...
    public override bool[] ToBitArray()
    {
      ...
      int index5 = index4 + 32;
      try
      {
        BitArray bitArray2 = Util.ConvertObjToBitArray((object) this.ResetToFactoryDefault, (int) this.ResetToFactoryDefault_len);
        bitArray2.CopyTo((Array) bit_array, index5);
        index5 += bitArray2.Length;
      }
      catch
      {
      }
      ...
      if (this.AntennaProperties != null)
      {
        ...
        for (int index6 = 0; index6 < length; ++index6)
          this.AntennaProperties[index6].ToBitArray(ref bit_array, ref cursor);
      }
      if (this.AntennaConfiguration != null)
      {
        int length = this.AntennaConfiguration.Length;
        for (int index6 = 0; index6 < length; ++index6)
          this.AntennaConfiguration[index6].ToBitArray(ref bit_array, ref cursor);
      }
      if (this.ROReportSpec != null)
      ...
      if (this.GPOWriteData != null)
      {
        int length = this.GPOWriteData.Length;
        for (int index6 = 0; index6 < length; ++index6)
          this.GPOWriteData[index6].ToBitArray(ref bit_array, ref cursor);
      }
      if (this.GPIPortCurrentState != null)
      {
        int length = this.GPIPortCurrentState.Length;
        for (int index6 = 0; index6 < length; ++index6)
          this.GPIPortCurrentState[index6].ToBitArray(ref bit_array, ref cursor);
      }
      if (this.EventsAndReports != null)
      ...
      if (this.Custom != null)
      {
        int length = this.Custom.Length;
        for (int index6 = 0; index6 < length; ++index6)
          this.Custom[index6].ToBitArray(ref bit_array, ref cursor);
      }
