...
// Type: Org.LLRP.LTK.LLRPV1.MSG_ADD_ACCESSSPEC_RESPONSE
...
namespace Org.LLRP.LTK.LLRPV1
{
  public class MSG_ADD_ACCESSSPEC_RESPONSE : Message
  {
    ...
    public static MSG_ADD_ACCESSSPEC_RESPONSE FromString(string str)
    {
      ...
      MSG_ADD_ACCESSSPEC_RESPONSE accessspecResponse = new MSG_ADD_ACCESSSPEC_RESPONSE();
      try
      {
    ...
    public static MSG_ADD_ACCESSSPEC_RESPONSE FromBitArray(
      ref BitArray bit_array,
      ref int cursor,
      int length)
    {
      if (cursor > length)
        return (MSG_ADD_ACCESSSPEC_RESPONSE) null;
