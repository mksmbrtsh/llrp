...
// Type: Org.LLRP.LTK.LLRPV1.PARAM_C1G2BlockWrite
...
namespace Org.LLRP.LTK.LLRPV1
{
  public class PARAM_C1G2BlockWrite : Parameter
  {
    ...
    public PARAM_C1G2BlockWrite() => this.typeID = (ushort) 347;

    public static PARAM_C1G2BlockWrite FromBitArray(
      ref BitArray bit_array,
      ref int cursor,
      int length)
    {
      if (cursor >= length)
        return (PARAM_C1G2BlockWrite) null;
      int num1 = cursor;
      int num2 = length;
      ArrayList arrayList = new ArrayList();
      PARAM_C1G2BlockWrite paramC1G2BlockWrite = new PARAM_C1G2BlockWrite();
      paramC1G2BlockWrite.tvCoding = bit_array[cursor];
      int val;
      if (paramC1G2BlockWrite.tvCoding)
      {
        ++cursor;
      ...
      else
      {
        ...
        paramC1G2BlockWrite.length = (ushort) Util.DetermineFieldLength(ref bit_array, ref cursor);
        num2 = num1 + (int) paramC1G2BlockWrite.length * 8;
      }
      if (val != (int) paramC1G2BlockWrite.TypeID)
      {
        cursor = num1;
        return (PARAM_C1G2BlockWrite) null;
      }
      ...
      paramC1G2BlockWrite.WriteData = (UInt16Array) obj;
      return paramC1G2BlockWrite;
    }

    public override string ToString()
    {
      string str = "<C1G2BlockWrite>" + "\r\n";
      try
      {
    ...
    public static PARAM_C1G2BlockWrite FromXmlNode(XmlNode node)
    {
      ...
      paramC1G2BlockWrite.OpSpecID = (ushort) Util.ParseValueTypeFromString(nodeValue1, "u16", "");
      string nodeValue2 = XmlUtil.GetNodeValue(node, "AccessPassword");
      paramC1G2BlockWrite.AccessPassword = (uint) Util.ParseValueTypeFromString(nodeValue2, "u32", "");
      string nodeValue3 = XmlUtil.GetNodeValue(node, "MB");
      paramC1G2BlockWrite.MB = TwoBits.FromString(nodeValue3);
      string nodeValue4 = XmlUtil.GetNodeValue(node, "WordPointer");
      paramC1G2BlockWrite.WordPointer = (ushort) Util.ParseValueTypeFromString(nodeValue4, "u16", "");
      string nodeValue5 = XmlUtil.GetNodeValue(node, "WriteData");
      paramC1G2BlockWrite.WriteData = (UInt16Array) Util.ParseArrayTypeFromString(nodeValue5, "u16v", "Hex");
      return paramC1G2BlockWrite;
    }
