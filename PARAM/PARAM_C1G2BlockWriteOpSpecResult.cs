...
namespace Org.LLRP.LTK.LLRPV1
{
  public class PARAM_C1G2BlockWriteOpSpecResult : Parameter
  {
    ...
    public static PARAM_C1G2BlockWriteOpSpecResult FromXmlNode(
      XmlNode node)
    {
      ArrayList arrayList = new ArrayList();
      ...
      writeOpSpecResult.Result = (ENUM_C1G2BlockWriteResultType) Enum.Parse(typeof (ENUM_C1G2BlockWriteResultType), nodeValue1);
