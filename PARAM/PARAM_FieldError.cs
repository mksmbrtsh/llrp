...
namespace Org.LLRP.LTK.LLRPV1
{
  public class PARAM_FieldError : Parameter
  {
    ...
    public static PARAM_FieldError FromBitArray(
    ...
    public static PARAM_FieldError FromXmlNode(XmlNode node)
    {
      ...
      PARAM_FieldError paramFieldError = new PARAM_FieldError();
      string nodeValue1 = XmlUtil.GetNodeValue(node, "FieldNum");
      paramFieldError.FieldNum = (ushort) Util.ParseValueTypeFromString(nodeValue1, "u16", "");
      string nodeValue2 = XmlUtil.GetNodeValue(node, "ErrorCode");
      paramFieldError.ErrorCode = (ENUM_StatusCode) Enum.Parse(typeof (ENUM_StatusCode), nodeValue2);
      return paramFieldError;
    }
