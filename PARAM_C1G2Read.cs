...
namespace Org.LLRP.LTK.LLRPV1
{
  public class PARAM_C1G2Read : Parameter
  {
    ...
    public static PARAM_C1G2Read FromBitArray(
    ...
    public static PARAM_C1G2Read FromXmlNode(XmlNode node)
    {
      ...
      paramC1G2Read.OpSpecID = (ushort) Util.ParseValueTypeFromString(nodeValue1, "u16", "");
      string nodeValue2 = XmlUtil.GetNodeValue(node, "AccessPassword");
      paramC1G2Read.AccessPassword = (uint) Util.ParseValueTypeFromString(nodeValue2, "u32", "");
      string nodeValue3 = XmlUtil.GetNodeValue(node, "MB");
      paramC1G2Read.MB = TwoBits.FromString(nodeValue3);
      string nodeValue4 = XmlUtil.GetNodeValue(node, "WordPointer");
      paramC1G2Read.WordPointer = (ushort) Util.ParseValueTypeFromString(nodeValue4, "u16", "");
      string nodeValue5 = XmlUtil.GetNodeValue(node, "WordCount");
      paramC1G2Read.WordCount = (ushort) Util.ParseValueTypeFromString(nodeValue5, "u16", "");
      return paramC1G2Read;
    }
